...
class SubtractionAgent(Agent):
    def __init__(self):
        super().__init__(name="subtraction_agent", role="Math Agent", goal="Subtract two numbers", backstory="Simple arithmetic agent")
    ...
    def run(self, state: dict) -> dict:
        ...
        result = a - b
        logger.info(f"SubtractionAgent: {a} - {b} = {result}")
